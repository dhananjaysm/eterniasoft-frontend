...
const Feedback = () => {
  return (
    <div className="col-span-12 bg-white border rounded-sm shadow-default dark:bg-boxdark border-stroke dark:border-strokedark xl:col-span-6">
      <div className="flex items-start justify-between px-6 py-5 border-b border-stroke dark:border-strokedark">
        <div>
        ...
        <div className="relative">
          ...
          <div className="shadow-default dark:bg-boxdark absolute right-0 top-full z-40 hidden w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 dark:border-strokedark">
      ...
      <div className="p-6">
        <div className="flex flex-col gap-7">
          <div className="relative z-1 flex gap-5.5">
            <div className="max-w-16 h-16 w-full rounded-full border-[3px] border-stroke dark:border-strokedark">
              <img
                alt="User"
                loading="lazy"
                width="64"
                ...
                decoding="async"
                data-nimg="1"
                srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-14.png&amp;w=64&amp;q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-14.png&amp;w=128&amp;q=75 2x"
                src="/_next/image?url=%2Fimages%2Fuser%2Fuser-14.png&amp;w=128&amp;q=75"
          ...
          <div className="relative z-1 flex gap-5.5">
            <div className="max-w-16 h-16 w-full rounded-full border-[3px] border-stroke dark:border-strokedark">
              <img
                ...
                decoding="async"
                data-nimg="1"
                srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-15.png&amp;w=64&amp;q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-15.png&amp;w=128&amp;q=75 2x"
                src="/_next/image?url=%2Fimages%2Fuser%2Fuser-15.png&amp;w=128&amp;q=75"
                style={{ color: "transparent;" }}
              />
            </div>
            <div>
              ...
              <span className="block mt-1 text-sm"> 2 hour ago</span>
              <p className="mt-2.5 text-black dark:text-white">
          ...
          <div className="relative z-1 flex gap-5.5">
            <div className="max-w-16 h-16 w-full rounded-full border-[3px] border-stroke dark:border-strokedark">
              <img
                ...
                decoding="async"
                data-nimg="1"
                srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-16.png&amp;w=64&amp;q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-16.png&amp;w=128&amp;q=75 2x"
                src="/_next/image?url=%2Fimages%2Fuser%2Fuser-16.png&amp;w=128&amp;q=75"
              />
            </div>
            <div>
              <p className="text-black dark:text-white">
