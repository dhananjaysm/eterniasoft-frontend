  ...
  return (
    <>
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-white border rounded-sm animate_top shadow-default border-stroke dark:border-strokedark dark:bg-boxdark lg:pt-20 xl:pb-30 xl:pt-30"
      >
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full p-4 text-white transition border rounded-sm cursor-pointer border-primary bg-primary hover:bg-opacity-90"
                  >
                    <div className="flex flex-row items-center gap-2 align-middle">
                      <span>Sign In</span>
                      <span>{loading ? <LoaderIcon /> : null}</span>
