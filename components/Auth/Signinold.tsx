...
const Signin = () => {
  ...
  // useMutation hook to execute the LOGIN_MUTATION
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    login(); // Execute the login mutation
  };
  ...
  return (
    <>
      {/* <!-- ===== SignIn Form Start ===== --> */}
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-20 xl:pb-30 xl:pt-30">
              ...
              <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                <div className="flex flex-wrap gap-4 md:gap-10">
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <span className="border-gray-300 bg-gray-100 dark:border-gray-600 dark:bg-gray-700 group mt-1 flex h-5 min-w-[20px] items-center justify-center rounded text-blue-600 peer-checked:bg-primary">
                      <svg
